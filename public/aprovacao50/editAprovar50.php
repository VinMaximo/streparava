...
if (isset($_GET["etiqueta"])) {
    ...
    $sql = "SELECT * FROM g50 WHERE etiqueta = '" . $etiqueta . "'";
...
?>
    ...
    <div class="form">
        <form action="updateAprovar50.php" method="POST" style="margin-left: 100px; margin-right: 100px;">
            <br>
            <br>
            ...
            <div class="buttons">
                ...
                <input type="reset" class="btn btn-danger" onclick="window.location.href='../aprovacao50/aprovar50.php'" value="Cancelar">
