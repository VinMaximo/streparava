...
?>
    ...
    <div class="form">
        <form action="updateAprovar65.php" method="POST" style="margin-left: 100px; margin-right: 100px;">
            <br>
            <br>
            ...
            <div class="buttons">
                ...
                <input type="reset" class="btn btn-danger" onclick="window.location.href='../aprovacao65/aprovar65.php'" value="Cancelar">
