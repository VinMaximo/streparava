...
<body>
    ...
    <div class="form">
        <form action="insertCod50.php" method="POST" style="margin-left: 100px; margin-right: 100px;">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default">Código novo G50</span>
                </div>
