...
<body>
    ...
    <div class="form">
        <form action="insertEtiqueta50.php" method="POST" style="margin-left: 100px; margin-right: 100px;">
            ...
            <div class="buttons">
                ...
                <input type="reset" class="btn btn-danger btn-sm" onclick="window.location.href='../montagem/listPDC.php'" value="Cancelar">
