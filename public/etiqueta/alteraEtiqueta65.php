...
$sql = $dbcon->query("SELECT coalesce( max( etiqueta ), 0) +1  FROM g65");
...
<body>
    ...
    <div class="form">
        <form action="../etiqueta/insertEtiqueta65.php" method="POST" style="margin-left: 100px; margin-right: 100px;">
