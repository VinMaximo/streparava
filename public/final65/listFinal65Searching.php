...
$sql = "SELECT *, DATE_FORMAT(data,'%d/%m/%Y') as datas FROM levantamento65f WHERE data  and (data LIKE '%$usuarios%' or etiqueta1 LIKE '%$usuarios%' or etiqueta2 LIKE '%$usuarios%') order by data DESC";
