...
<body>
    ...
    <div class="buttons">
                <a href="../montagemG50/createPDC50.php" class="btn btn-primary">Cadastre uma planilha de controle</a>
        </div>
	...
	<?php include("../montagemG50/listPDC50NoSearch.php") ?>
	...
	$(function() {
		...
		$("#pesquisa").keyup(function() {
			...
			if (pesquisa != '') {
				...
				$.post('listPDC50Searching.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			} else {
				$.post('listPDC50NoSearch.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			}
