...
<body>
    ...
    <div class="buttons">
                <a href="../montagemG65/createPDC65.php" class="btn btn-primary">Cadastre uma planilha de controle</a>
        </div>
	...
	<?php include("../montagemG65/listPDC65NoSearch.php") ?>
	...
	$(function() {
		...
		$("#pesquisa").keyup(function() {
			...
			if (pesquisa != '') {
				...
				$.post('listPDC65Searching.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			} else {
				$.post('listPDC65NoSearch.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			}
