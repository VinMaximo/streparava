...
<body>
    ...
    <div class="buttons">
                <a href="../montagemG70/createPDC70.php" class="btn btn-primary">Cadastre uma planilha de controle</a>
        </div>
	...
	<?php include("../montagemG70/listPDC70NoSearch.php") ?>
	...
	$(function() {
		...
		$("#pesquisa").keyup(function() {
			...
			if (pesquisa != '') {
				...
				$.post('listPDC70Searching.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			} else {
				$.post('listPDC70NoSearch.php', dados, function(retorna) {
					//Mostra dentro da ul os resultado obtidos 
					$(".resultado").html(retorna);
				});
			}
